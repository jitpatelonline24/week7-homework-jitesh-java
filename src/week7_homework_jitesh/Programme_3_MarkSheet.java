...
public class Programme_3_MarkSheet {
    ...
    public static void main(String[] args) {
        ...
        int mathsMaths = scanner.nextInt();
        if (mathsMaths < 0 || mathsMaths > 100) {
            System.out.print("\nInvalid input,Marks should between 0 to 100");
            System.out.print("\nEnter correct marks \t \t:\t");
            mathsMaths = scanner.nextInt();
        }
        ...
        int total = sum(mathsMaths, scienceMarks, englishMarks);
        int percentage = (total * 100) / 300;
        String result = calculateResult(mathsMaths, scienceMarks, englishMarks);
        String grade = calculateGrade(percentage, result);
        printTheMarkSheet(name, rollNum, mathsMaths, scienceMarks, englishMarks, total, percentage, result, grade);
